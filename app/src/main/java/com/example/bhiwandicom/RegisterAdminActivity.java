        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child("Users").child(phone).exists()))
                {
                    ...
                    RootRef.child("Admins").child(phone).updateChildren(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            ...
                            else
                            {
                                ...
                                Toast.makeText(RegisterAdminActivity.this, "Error Occurred :" + msg, Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
                ...
                {
                    Toast.makeText(RegisterAdminActivity.this, "The number already exist...", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Intent welIntent = new Intent(RegisterAdminActivity.this,LoginPhoneActivity.class);
